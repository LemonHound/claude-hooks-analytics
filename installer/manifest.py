COMPONENTS = [
    ...
    {"id": "pre_compact", "label": "Context compaction", "description": "Records when context is compacted and the trigger (auto/manual).", "kind": "hook", "default_enabled": True, "event": "PreCompact", "matcher": None, "async": True, "timeout": None, "script": "pre_compact.py"},
    {"id": "notification", "label": "Notifications", "description": "Records permission prompts and idle-waiting notifications.", "kind": "hook", "default_enabled": True, "event": "Notification", "matcher": None, "async": True, "timeout": None, "script": "notification.py"},
